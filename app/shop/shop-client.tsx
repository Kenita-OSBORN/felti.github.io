...
export function ShopClient({ initialProducts }: { initialProducts: Product[] }) {
  ...
  useEffect(() => {
    ...
    dottiApi
      ...
      .catch((error) => {
        setError(error instanceof Error ? error.message : 'Products could not be loaded.');
      });
  }, []);
    ...
    <PageShell title="Shop" eyebrow="Finished Accessories">
      ...
      <div className="mt-8 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
        ...
        {shopProducts.length === 0 && (
          <div className="col-span-full rounded-[28px] bg-white p-8 text-center text-[var(--dotti-muted)] shadow-sm ring-1 ring-[var(--dotti-border)]">
